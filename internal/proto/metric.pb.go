...
const file_proto_metric_proto_rawDesc = "" +
	...
	"\x15UpdateMetricsResponse\"X\n" +
	"\x06Metric\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12\x14\n" +
	"\x05delta\x18\x03 \x01(\x12R\x05delta\x12\x14\n" +
	"\x05value\x18\x04 \x01(\x02R\x05value2V\n" +
	"\rMetricService\x12E\n" +
	"\x06Update\x12\x1c.metric.UpdateMetricsRequest\x1a\x1d.metric.UpdateMetricsResponseB\x0eZ\fproto/metricb\x06proto3"
...
var file_proto_metric_proto_goTypes = []any{
	...
	(*UpdateMetricsResponse)(nil), // 1: metric.UpdateMetricsResponse
	(*Metric)(nil),                // 2: metric.Metric
}
var file_proto_metric_proto_depIdxs = []int32{
	2, // 0: metric.UpdateMetricsRequest.metrics:type_name -> metric.Metric
	0, // 1: metric.MetricService.Update:input_type -> metric.UpdateMetricsRequest
	1, // 2: metric.MetricService.Update:output_type -> metric.UpdateMetricsResponse
